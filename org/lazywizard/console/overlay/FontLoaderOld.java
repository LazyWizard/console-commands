...
public class FontLoaderOld
{
    ...
    public static LazyFont loadFont(String fontPath) throws FontException
    {
        ...
        try
        {
            ...
            final LazyFont font = new LazyFont(textureId, baseHeight, textureWidth, textureHeight);
            ...
            for (String kernLine : kernLines)
            {
                ...
                font.getChar((char) id).setKerning(otherId, kernAmount);
            }
     ...
     * @since 3.0
     */
    public static class FontExceptionOld extends Exception
    {
        public FontExceptionOld(String message)
        {
            super(message);
        }

        public FontExceptionOld(String message, Throwable cause)
        {
            super(message, cause);
        }

        public FontExceptionOld(Throwable cause)
        {
            super(cause);
        }
    }
